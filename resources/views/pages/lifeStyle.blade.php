      ...
      <article>
        ...
        <div class="clothes-pics">
          <div class="row img-row">
            <figure class="columns four"><img src="{{asset('public/images/model1.jpg')}}">
              <figcaption>BlackBird Sweater - <strong>$135</strong></figcaption>
            </figure>
            <figure class="columns four"><img src="{{asset('public/images/model2.jpg')}}">
              <figcaption>BlackBird Trousers - <strong>$135</strong></figcaption>
            </figure>
            <figure class="columns four"><img src="{{asset('public/images/model3.jpg')}}">
