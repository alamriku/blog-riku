...
<head>
   ...
   <link href="{{asset('public/admin_assets/css/modalStyle.css')}}" rel="stylesheet" />
 ...
 <!--  <script type='text/javascript'>
    ...
    {
        chk = confirm("Ary You Sure to delete this record");
        if(chk)
        {
            return true;
        }
...
<body class="fixed-top">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      ...
                      <li><a class="" href="{{URL::to('/manage-comment')}}">Manage-comments</a></li>
   ...
   <script src="{{asset('public/admin_assets/js/modalStyle.js')}}"></script>
