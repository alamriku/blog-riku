...
<head>
   ...
   <link href="{{asset('public/admin_assets/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" />
   <link href="{{asset('public/admin_assets/bootstrap/css/bootstrap-responsive.min.css')}}" rel="stylesheet" />
    ...
    <div class="login-wrap">
        ...
        <div class="metro single-size red">
            <h3>
                ...
                {
                    echo $exception;
                    Session::put('exception'," ");//its indicate to empty expetion after refresh,"empty string will do that by t his session"
                }
                ?>
            </h3>
            <h3>
